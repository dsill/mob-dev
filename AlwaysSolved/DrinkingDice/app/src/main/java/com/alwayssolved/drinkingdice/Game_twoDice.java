...
public class Game_twoDice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        diceImages.put(1, Integer.valueOf(R.drawable.one));
        diceImages.put(2, Integer.valueOf(R.drawable.two ));
        diceImages.put(3, Integer.valueOf(R.drawable.three));
        diceImages.put(4, Integer.valueOf(R.drawable.four ));
        diceImages.put(5, Integer.valueOf(R.drawable.five));
        diceImages.put(6, Integer.valueOf(R.drawable.six ));
