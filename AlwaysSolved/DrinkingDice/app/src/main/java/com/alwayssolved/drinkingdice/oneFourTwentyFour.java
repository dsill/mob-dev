...
public class oneFourTwentyFour extends AppCompatActivity {
    ...
    int isQualifiedOne = 0;         //0 if "One" is not locked yet
    int isQualifiedFour = 0;        //0 if "Four" is not locked yet
    ...
    public void HandleRollClick(View v) {
        ...
        //TODO: register values of selected dice
        //TODO: set "qualified" values
        //TODO: check if all dice have been locked and then register total score
    ...
    Handler.Callback callback = new Handler.Callback() {
        public boolean handleMessage(Message msg) {
            ...
            if (!dicePicture3.isSelected()) {
                //Show roll result
                dicePicture3.setImageResource(diceImages.get(rng.nextInt(6) + 1));
            }

            if (!dicePicture4.isSelected()) {
                //Show roll result
                dicePicture4.setImageResource(diceImages.get(rng.nextInt(6) + 1));
            }

            if (!dicePicture5.isSelected()) {
                //Show roll result
                dicePicture5.setImageResource(diceImages.get(rng.nextInt(6) + 1));
            }

            if (!dicePicture6.isSelected()) {
                //Show roll result
                dicePicture6.setImageResource(diceImages.get(rng.nextInt(6) + 1));
            }
